 ...
 * \ingroup freeRTOS
 * \defgroup SchedulerControl Scheduler Control
 * \ingroup freeRTOS
 * \defgroup TaskCtrl Task Control
 * \ingroup freeRTOS
 * \defgroup TaskUtils Task Utilities
 * \ingroup freeRTOS
 * \defgroup TaskNotifications Task Notifications
 * \ingroup freeRTOS
 */
